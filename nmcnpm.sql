CREATE DATABASE QuanLyNhaSachCNPM
GO
USE QuanLyNhaSachCNPM
GO
...
(
	...
	MaKH CHAR(10) NOT NULL,
	NgayThu SMALLDATETIME NOT NULL DEFAULT GETDATE(),
	SoTienThu SMALLMONEY NOT NULL,
	CONSTRAINT pk_PhieuThuTien PRIMARY KEY (MaPTT),
	CONSTRAINT fk_PhieuThuTien FOREIGN KEY (MaKH) REFERENCES KhachHang (MaKH)
)

CREATE TABLE BaoCaoCongNo
(
	MaBCCN CHAR(10) NOT NULL,
	MaKH CHAR(10) NOT NULL,
	MaPTT CHAR(10) NOT NULL,
	Thang INT, 
	...
	CONSTRAINT fk_BaoCaoCongNo_PhieuThuTien FOREIGN KEY (MaPTT) REFERENCES dbo.PhieuThuTien(MaPTT),
	CONSTRAINT fk_BaoCaoCongNo_KhachHang FOREIGN KEY (MaKH) REFERENCES KhachHang (MaKH)
)

CREATE TABLE BaoCaoTonKho
(
	MaBCTK CHAR(10) NOT NULL,
	MaSach CHAR(10) NOT NULL,
	Thang INT, 
	TonDau INT NOT NULL,
	TonCuoi INT NOT NULL,
	PhatSinh INT NOT NULL,
	CONSTRAINT fk_BaoCaoTonKho FOREIGN KEY (MaSach) REFERENCES dbo.Sach (MaSach),
...
INSERT INTO dbo.KhachHang VALUES  ('KH01','Nguyen Van A','731 Tran Hung Dao, Q5, TpHCM','8823451', 'nguyenvana@gmail.com' )
INSERT INTO dbo.KhachHang VALUES  ('KH02','Tran Ngoc Han','23/5 Nguyen Trai, Q5, TpHCM','908256478','tranngochan@gmail.com')
INSERT INTO dbo.KhachHang VALUES  ('KH03','Tran Ngoc Linh','45 Nguyen Canh Chan, Q1, TpHCM','938776266','tranngoclinh@gmail.com' )
INSERT INTO dbo.KhachHang VALUES  ('KH04','Tran Minh Long','50/34 Le Dai Hanh, Q10, TpHCM','917325476','tranminhlong@gmail.com' )
INSERT INTO dbo.KhachHang VALUES  ('KH05','Le Nhat Minh','34 Truong Dinh, Q3, TpHCM','8246108','lenhatminh@gmail.com')
INSERT INTO dbo.KhachHang VALUES  ('KH06','Le Hoai Thuong','227 Nguyen Van Cu, Q5, TpHCM','8631738','lehoaithuong@gmail.com' )
INSERT INTO dbo.KhachHang VALUES  ('KH07','Nguyen Van Tam','32/3 Tran Binh Trong, Q5, TpHCM','916783565','nguyenvantam@gmail.com')
INSERT INTO dbo.KhachHang VALUES  ('KH08','Phan Thi Thanh','45/2 An Duong Vuong, Q5, TpHCM','938435756','phanthithanh@gmail.com' )
INSERT INTO dbo.KhachHang VALUES  ('KH09','Le Ha Vinh','873 Le Hong Phong, Q5, TpHCM','8654763','lehavinh@gmail.com' )
INSERT INTO dbo.KhachHang VALUES  ('KH10','Ha Duy Lap','34/34B Nguyen Trai, Q1, TpHCM','8768904','haduylap@gmail.com' )
...
@tennxb NVARCHAR(50),@manxb CHAR(10),@diachi NVARCHAR(50), @sdt VARCHAR(20)
AS
BEGIN
...
@tentg NVARCHAR(40),@matg CHAR(10),@sdt VARCHAR(40)
AS
BEGIN 
	INSERT INTO TacGia
	(
...
ALTER TABLE dbo.TaiKhoan ADD NhapSach INT, ThongKe INT, KeSach INT , ThemDuLieu INT , BanSach INT, TTTaiKhoan INT 
